...
export function SignInForm() {
  ...
  return (
    <div className="w-full max-w-md space-y-8">
      <div>
        <h2 className="bg-background bg-primary text-black border-2 border-black rounded-md p-2 mt-6 text-center text-3xl font-bold  tracking-tight text-foreground">
